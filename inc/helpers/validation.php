...
class Validation
{
    ...
    public function validate_and_save_new_data_of_user($data, $role)
    {
        ...
        $result = apply_filters('' . PLUGIN_PREFIX . '_custom_validation_on_user_update',  $data, $role);
        ...
        $result = apply_filters('' . PLUGIN_PREFIX . '_custom_save_on_user_update', $data, $role);

        //Either the new data or a WP_Error
        return $result;
    }
    ...
    public function validate_and_register_new_user($data, $role)
    {
        ...
        $result = apply_filters('' . PLUGIN_PREFIX . '_custom_validation_on_user_registration', $data, $role);
